        ...
        <div className="container-apple">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            >
              ...
              <div className="p-8">
                <p className="text-sm text-apple-gray-500 dark:text-apple-gray-400 mb-3 font-medium">May 2, 2024</p>
                <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors duration-300">
                  Business Strategy in the Digital Age
                </h3>
                <p className="text-apple-gray-600 dark:text-apple-gray-300 mb-5">
                  Exploring how digital transformation is reshaping business strategies across industries.
                </p>
                <Link href="/blog/business-strategy-digital-age" className="inline-flex items-center text-primary font-medium group-hover:translate-x-1 transition-transform duration-300">
                  Read More
            ...
            >
              <div className="h-52 bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute w-32 h-32 rounded-full bg-white/20 -top-10 -right-10 group-hover:scale-125 transition-transform duration-700"></div>
                <div className="absolute w-24 h-24 rounded-full bg-primary/30 bottom-5 -left-10 group-hover:scale-110 transition-transform duration-700 delay-100"></div>
              ...
              <div className="p-8">
                <p className="text-sm text-apple-gray-500 dark:text-apple-gray-400 mb-3 font-medium">April 28, 2024</p>
                <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors duration-300">
                  Leadership Principles for Modern Teams
                </h3>
                <p className="text-apple-gray-600 dark:text-apple-gray-300 mb-5">
                  Key leadership principles that drive success in today&apos;s fast-paced business environment.
                </p>
                <Link href="/blog/leadership-principles-modern-teams" className="inline-flex items-center text-primary font-medium group-hover:translate-x-1 transition-transform duration-300">
                  Read More
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
            ...
            >
              <div className="h-52 bg-gradient-to-br from-primary/15 to-primary/5 flex items-center justify-center relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute w-32 h-32 rounded-full bg-white/20 -top-10 -right-10 group-hover:scale-125 transition-transform duration-700"></div>
                <div className="absolute w-24 h-24 rounded-full bg-primary/30 bottom-5 -left-10 group-hover:scale-110 transition-transform duration-700 delay-100"></div>
              ...
              <div className="p-8">
                <p className="text-sm text-apple-gray-500 dark:text-apple-gray-400 mb-3 font-medium">April 15, 2024</p>
                <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors duration-300">
                  The Future of Work: Trends and Predictions
                </h3>
                <p className="text-apple-gray-600 dark:text-apple-gray-300 mb-5">
                  Analyzing emerging workplace trends and what they mean for businesses and professionals.
                </p>
                <Link href="/blog/future-work-trends-predictions" className="inline-flex items-center text-primary font-medium group-hover:translate-x-1 transition-transform duration-300">
                  Read More
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
