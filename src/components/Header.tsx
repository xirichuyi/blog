  ...
  return (
    <header className="navbar-apple">
        ...
        <nav className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <motion.button
              ...
              className="md:hidden ml-2 w-10 h-10 rounded-full flex items-center justify-center text-apple-gray-600 dark:text-apple-gray-300 hover:bg-apple-gray-200 dark:hover:bg-apple-gray-700 transition-colors"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            className="md:hidden mobile-menu-container bg-white/95 dark:bg-apple-gray-900/95 border-t border-apple-gray-200 dark:border-apple-gray-700"
              ...
              <div className="flex flex-col space-y-4">
                {navLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      href={link.href}
                      className="block py-2 text-apple-gray-900 dark:text-white font-medium hover:text-primary transition-colors text-lg"
