...
pub async fn create_category(
    ...
    match services.category.create_category(request).await {
...
pub async fn list_categories(
    ...
    match services.category.list_categories().await {
...
pub async fn update_category(
    ...
    match services.category.update_category(id, request).await {
...
pub async fn delete_category(
    ...
    match services.category.delete_category(id).await {
