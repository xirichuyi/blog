...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed w-64 lg:w-72 bg-gray-800 shadow-md hidden md:block border-r border-gray-700 h-full">
      <div className="p-6">
      ...
      <div className="absolute bottom-0 w-full p-6">
        <Link
          to="/"
          className="flex items-center text-sm font-medium text-gray-300 hover:text-primary"
        >
          <span className="mr-2">
